...
gulp.task('copy-deploy-app', function() {
    var sourceFiles = [ 'app/**' ];
    return gulp.src(sourceFiles)
        .pipe(gulp.dest('../connector-deploy/connector-service/app'));
});

gulp.task('copy-app-swagger', function() {
    var sourceFiles = [ 'swagger/**' ];
    return gulp.src(sourceFiles)
        .pipe(gulp.dest('../connector-deploy/connector-service/swagger'));
});
...
gulp.task('deploy', ['monitor', 'copy-app', 'copy-deploy-app', 'copy-app-scripts', 'copy-app-swagger'], function() {
